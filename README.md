...
STUDENT → LEARNING QUERY → QUERY ANALYSIS → EMBEDDING GENERATION → VECTOR DATABASE SEARCH → RAG + LLM PROCESSING → PERSONALIZED RECOMMENDATIONS → FEEDBACK COLLECTION → IMPROVED RECOMMENDATIONS → STUDENT
